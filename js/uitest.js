var UITest = new function() {
	...
	function writeList() {
		...
		var scripts = _testScripts.length;
		var html = new Array();
		
		html.push('<table>');
		html.push('<thead><tr><th colspan="3"><a href="index.html" target="_parent">List of tests</a></th></tr></thead>');
		html.push('<tbody>');
		for(var i=0; i < scripts; i++) {
			html.push('<tr id="test-status-' + i + '">');
			html.push('<th>' + _testScripts[i].name + '</th>');
			html.push('<td><a href="index.html?' + i + '" target="_parent">run</a></td>');
			html.push('<td><a href="index.html?' + i + '&slow" target="_parent">slow</a></td>');
			html.push('<td><a href="index.html?' + i + '&notests" target="_parent">no tests</a></td>');
			html.push('</tr>');
		}
		html.push('<tr>');
		html.push('<th>All tests</th>');
		html.push('<td><a href="index.html?all" target="_parent">run</a></td>');
		html.push('<td><a href="index.html?all&slow" target="_parent">slow</a></td>');
		html.push('<td></td>');
		html.push('</tr>');
